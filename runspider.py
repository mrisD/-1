...
def main():
    starturl = "https://api.acgice.com/api/sjz/item_list?a=ammo&top=1-2&p=pagenumber&grade=-1&n=&token=b36c116f2db9363d5feeda08e6a0fb1c&timestamp=1754637197"
    ...
    process.crawl(SjzSpider, starturl=starturl, pagemax=pagemax)
    process.start()
